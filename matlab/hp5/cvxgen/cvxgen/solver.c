...
double eval_objv(void) {
  ...
  objv += work.quad_548686778368[0]+work.quad_183018455040[0]+work.quad_19734581248[0]+work.quad_653725216768[0]+work.quad_975577374720[0]+work.quad_114801700864[0]+work.quad_871133241344[0]+work.quad_176290516992[0];
  return objv;
}
