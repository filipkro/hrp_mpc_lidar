...
typedef struct Workspace_t {
  ...
  double quad_101480980480[1];
  double quad_375411109888[1];
  double quad_516089159680[1];
  double quad_2108211200[1];
  double quad_982054891520[1];
  double quad_188000112640[1];
